            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="defaultpicture" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == defaultpicture ? 'active ' : ''"
                    >
                      >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == defaultpicture ? 'active ' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == defaultpicture ? 'active ' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == defaultpicture ? 'active ' : ''"
                    >
...
export default {
  ...
  data() {
    return {
      defaultpicture: "img/mickey1.jpg",
      thumbs: [
        "img/mickey1.jpg",
        "img/mickey2.jpg",
        "img/mickey3.jpg",
